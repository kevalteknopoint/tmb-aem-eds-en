...
export default function decorate(block) {
  ...
  const iframeLinkElement = block.querySelector('.calculator-item2 .calculator-inner-item1 a');
  const iframeJsLinkElement = block.querySelector('.calculator-item3 .calculator-inner-item1 a');
