...
document.addEventListener('click', (e) => {
  if (e.target.closest('.banking-goods .button-container')) {
    ...
    ctaInteraction(pageRegion, minifyText(secondaryLink?.textContent), minifyText(ctaTitle?.textContent) , '', 'banking goods','banking goods',componentIndex,getPersona(),nextPageURL,'cta-link','internal','quick-link','in-content','','','','','','','','');
  }   
});
